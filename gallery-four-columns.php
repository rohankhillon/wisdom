						...
						<div class="gallery-wrap">
							<div class="gallery-card">
								<a href="img/gallery-popup-5.jpg" class="color-2" data-featherlight="image">
									<img src="img/gallery-page-1.jpg" alt="gallery">
									<span class="hide-desc h5">Learn With Fun</span>
								</a>
							</div>
							<div class="gallery-card">
								<a href="img/gallery-popup-12.jpg" class="color-2" data-featherlight="image">
									<img src="img/gallery-page-2.jpg" alt="gallery">
									<span class="hide-desc h5">Learn With Fun</span>
								</a>
							</div>
							<div class="gallery-card">
								<a href="img/gallery-popup-3.jpg" class="color-2" data-featherlight="image">
									<img src="img/gallery-page-3.jpg" alt="gallery">
									<span class="hide-desc h5">Learn With Fun</span>
								</a>
							</div>
							<div class="gallery-card">
								<a href="img/gallery-popup-6.jpg" class="color-2" data-featherlight="image">
									<img src="img/gallery-page-4.jpg" alt="gallery">
									<span class="hide-desc h5">Learn With Fun</span>
								</a>
							</div>
							<div class="gallery-card">
								<a href="img/gallery-popup-4.jpg" class="color-2" data-featherlight="image">
									<img src="img/gallery-page-5.jpg" alt="gallery">
									<span class="hide-desc h5">Learn With Fun</span>
								</a>
							</div>
							<div class="gallery-card">
								<a href="img/gallery-popup-11.jpg" class="color-2" data-featherlight="image">
									<img src="img/gallery-page-6.jpg" alt="gallery">
									<span class="hide-desc h5">Learn With Fun</span>
								</a>
							</div>
							<div class="gallery-card">
								<a href="img/gallery-popup-9.jpg" class="color-2" data-featherlight="image">
									<img src="img/gallery-page-7.jpg" alt="gallery">
									<span class="hide-desc h5">Learn With Fun</span>
								</a>
							</div>
							<div class="gallery-card">
								<a href="img/gallery-popup-13.jpg" class="color-2" data-featherlight="image">
									<img src="img/gallery-page-8.jpg" alt="gallery">
									<span class="hide-desc h5">Learn With Fun</span>
								</a>
							</div>
						</div>
...
<!-- Mirrored from alisena-html.buzline.org/gallery-four-columns.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Jan 2019 04:17:22 GMT -->
</html>