...
?>		
		<!-- End header -->
		<!-- Begin page name -->
		<section class="page-name type-2 color-5">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
...
<!-- Mirrored from alisena-html.buzline.org/custom-page-one.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Jan 2019 04:17:22 GMT -->
</html>