...
?>		
		<!-- End header -->
		<!-- Begin page name -->
		<section class="page-name type-3 color-5">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
			...
			<div class="footer-top-content">
				<div class="container">
					<div class="row row-flex">
						...
						<!-- Begin footer map -->
						<div class="col-xs-12 col-sm-6 col-sm-offset-0 col-md-6 col-md-offset-1 col-lg-4 col-lg-offset-1">
							<!-- Begin footer map -->
...
<!-- Mirrored from alisena-html.buzline.org/custom-page-two.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Jan 2019 04:17:22 GMT -->
</html>